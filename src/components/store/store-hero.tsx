...
export function StoreHero() {
  ...
  return (
    <section className="store-hero-wash relative min-h-[92vh] flex flex-col justify-end overflow-hidden px-5 sm:px-8 lg:px-12 pb-14 pt-36">
      <p className="absolute left-5 sm:left-8 lg:left-12 top-36 text-[10px] tracking-[0.42em] uppercase text-brass">
        Atelier · fresh cut
      </p>
